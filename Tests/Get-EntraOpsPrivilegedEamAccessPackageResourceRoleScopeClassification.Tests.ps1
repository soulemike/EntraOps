...
BeforeAll {
    ...
    . "$PSScriptRoot/../EntraOps/Private/Get-EntraOpsAadApplicationClassification.ps1"
    . "$PSScriptRoot/../EntraOps/Private/Resolve-EntraOpsSharePointOnlineRoleTier.ps1"
    . "$PSScriptRoot/../EntraOps/Private/Get-EntraOpsPrivilegedEamAccessPackageResourceRoleScopeClassification.ps1"
}
