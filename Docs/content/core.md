...
| `DevOpsPlatform`                                                                                                                                                               | `GitHub` enables the shipped federated-credential and workflow automation path. `AzureDevOps` is accepted for custom integrations, but EntraOps does not currently ship Azure Pipelines templates or automatic federated credential setup for it. Use `None` for configured local/custom automation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `AutomatedEntraOpsUpdate`                                                                                                                                                      | Configure automated updates of the EntraOps-managed repository content. Disabled by default; when enabled it uses `Repository: EntraOps` (public release channel, no secret), `PublicationMode: PullRequest`, `Branch: main`, `ValidationFrequency: OnChange`, and browser validation. Workflow definitions are excluded from the default targets; opt in only for a manual cmdlet update or after configuring the dedicated publisher GitHub App. `PullRequest` mode requires the repository to allow GitHub Actions to create pull requests. Use `DirectPush` only for repositories that intentionally accept unattended writes to the current branch - see [Update EntraOps repository and CI/CD](#update-entraops-powershell-module-and-cicd).                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `AutomatedReportingGeneration.ApplyAutomatedReportingGeneration`                                                                                                               | Generate the selected static Reporting apps in the GitHub reporting workflow and upload them as a 30-day artifact. Disabled by default.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
